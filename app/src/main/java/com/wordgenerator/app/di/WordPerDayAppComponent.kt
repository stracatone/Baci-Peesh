...
@Singleton
@Component(
        modules = [AndroidSupportInjectionModule::class, ApplicationModule::class, MainActivityModule::class, AddWordFragmentModule::class, ReadFragmentModule::class, WordsModule::class])
